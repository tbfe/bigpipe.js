(function() {
    ...
    Pagelet.prototype = {
        ...
        _getPalceholder: function(document) {
        ...
        _getHTML: function() {
            ...
            return container.innerHTML.match(/^<!--(.*)-->$/)[1];
        },
        parent: function() {
        ...
        appendTo: function(pagelet) {
            ...
            if (!pagelet.document) {
                ...
                this.document = this._getPalceholder(pagelet.document);
    ...
    Bigpipe.config = function(options) {
        ...
        if (typeof options._getPalceholder === 'function') {
            Pagelet.prototype._getPalceholder = options._getPalceholder;
        }
    };
