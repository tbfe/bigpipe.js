(function () {
    ...
    styleLoader.load = function (ids) {
        ...
        var createLoadStyle = function (url) {
            var loadStyle = new Promise(function (resolve) {
                var loader = styleLoader._loaders[url];
                if (loader) {
                    loader.then(resolve);
                } else {
            ...
            styleLoader._loaders[url] = loadStyle;
    ...
    var BigpipeEventConfig = {
        beforePageletInit: function (pagelet) {

        },
        onPageletStyleLoaded: function (pagelet) {

        },
        onPageletScriptLoaded: function (pagelet) {
        ...
        _init: function () {
            ...
            var mounter = new Promise(function (resolve) {
                ...
                styleLoader.then(function () {
                    ...
                    BigpipeEventConfig.beforePageletInit(this);
                    this.emit('pageletstyleloaded');
                    BigpipeEventConfig.onPageletStyleLoaded(this);
                }.bind(this));
            }.bind(this));

            return Promise.all([mounter, scriptLoader]).then(function () {
                this.emit('pageletscriptloaded')
                BigpipeEventConfig.onPageletScriptLoaded(this);
            }.bind(this));
        },
    ...
    Bigpipe.end = function () {
        ...
        Promise.all(loadPagelets).then(function () {
            ...
            BigpipeEventConfig.onPageLoaded(pagelets);
    ...
    Bigpipe.config = function (options) {
        ...
        if (options.eventConfig) {
            BigpipeEventConfig = options.eventConfig;
        }
    };
